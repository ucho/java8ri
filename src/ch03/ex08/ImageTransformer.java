...
interface ColorTransformer {
    ...
    static ColorTransformer borderGenerator(Image image, int width, Color borderColor) {
        return (x, y, c) -> {
...
public class ImageTransformer extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Image transformed = transform(image, ColorTransformer.borderGenerator(image, 20, Color.RED));
